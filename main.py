...
player_images = []
for i in range(1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'lib/player_images/{i}.png'), (45, 45)))
blinky_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/red.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/pink.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/blue.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/orange.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/powerup.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'lib/ghost_images/dead.png'), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
...
class Ghost:
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 30 < 29:
            ...
            self.turns[0] = True
            self.turns[1] = True
        if 350 < self.x_pos < 500 and 370 < self.y_pos < 480:
            self.in_box = True
        else:
            self.in_box = False
...
def check_collision(scor, power, power_count, eaten_ghost):
    num1 = (HEIGHT - 50) // 32
    num2 = WIDTH // 30
    if 0 < player_x < 870:
...
while run:
    ...
    score, power_up, power_counter, eaten_ghost = check_collision(score, power_up, power_counter, eaten_ghost)
